class User < ApplicationRecord
  ...
  has_many :followers, -> {where(accepted: true)}, class_name: "Follow", foreign_key: 'followed_id'
  has_many :accepted_received_requests, -> {where(accepted: false)}, class_name: "Follow", foreign_key: 'followed_id'
